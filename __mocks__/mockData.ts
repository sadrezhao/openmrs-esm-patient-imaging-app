...
export const testProcedureSteps: Array<RequestProcedureStep> = [
  {
    ...
    modality: 'CT',
    aetTitle: 'AET_CT1',
    scheduledPerformingPhysician: 'Dr. Alice Morgan',
  ...
  },
  {
    ...
    modality: 'MR',
    aetTitle: 'AET_MR2',
    scheduledPerformingPhysician: 'Dr. Brian Lee',
  ...
  },
  {
    ...
    modality: 'US',
    aetTitle: 'AET_US3',
    scheduledPerformingPhysician: 'Dr. Claire Zhang',
  ...
  },
  {
    ...
    modality: 'CR',
    aetTitle: 'AET_CR4',
    scheduledPerformingPhysician: 'Dr. Daniel Kim',
