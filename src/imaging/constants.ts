...
export const unlinkStudyConfirmationDialog = 'study-unlink-confirmation-dialog';
export const updateProcedureStepStatusDialog = 'update-procedureStep-status-dialog';
export const linkStudyConfirmationDialog = 'link-study-confirmation-dialog';
