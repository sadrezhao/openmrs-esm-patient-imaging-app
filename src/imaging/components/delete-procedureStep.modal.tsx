...
import { deleteProcedureStep, getProcedureStep } from '../../api';
...
const DeleteProcedureStepModal: React.FC<DeleteProcedureStepModalProps> = ({
    closeDeleteModal,
    requestId,
    stepId,
}) => {
    const { t } = useTranslation();
    const { mutate } = getProcedureStep(requestId);
    ...
    },[closeDeleteModal, requestId, stepId, mutate, t])
